...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-primary">Transaction Report</h5>
    </div>
    <div class="card-body">
        ...
        <div clas="table-responsive mb-5">
            <table class="display datatable table " style="width:100%">
                ...
                <tbody>
                    @foreach($cash_all_bookings as $booking)
                    <tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td>Cash Total Sum Fare (RM) :</td>
                        <td>{{ $cash_total_sum_fare }}</td>
                    </tr>
                </tfoot>
            </table>
    </div>
    <div clas="table-responsive mt-5">
        <table class="display datatable table " style="width:100%">
            <thead>
                <tr>
                    <th>Booking No</th>
            ...
            <tbody>
                @foreach($paypal_all_bookings as $booking)
                <tr>
                    <td>{{ $booking->booking_no }}</td>
                    <td>{{ $booking->name }} ({{ $booking->phone_num }})</td>
                    <td>{{ $booking->user->email }}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td>Paypal Total Sum Fare (RM) :</td>
                    <td>{{ $paypal_total_sum_fare }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
