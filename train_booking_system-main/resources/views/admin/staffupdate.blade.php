...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <!-- Add Form -->
            <form action="{{ route("admin.staff.update.submit") }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="type" name="type" required>
                        <option value="20" {{ $usere->type == 20? "selected":"" }}>Normal Admin</option>
                        <option value="30" {{ $usere->type == 30? "selected":"" }}>Super Admin</option>
                    </select>
                    @error('type')
