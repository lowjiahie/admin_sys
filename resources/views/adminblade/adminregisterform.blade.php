    ...
    <body>
        <form action="{{route('registernewAdmin')}}" method="post">
            ...
            <div class="container">
                ...
                <input type="text" placeholder="Enter Position" name="position" id="position" value="{{old('position')}}">
                
                <label for="yearstarted"><b>Year Started</b></label>
                <span class="text-danger">@error('yearstarted'){{$message}}@enderror</span>
                <input type="text" placeholder="Enter Year Started" name="yearstarted" id="yearstarted" value="{{old('yearstarted')}}">
